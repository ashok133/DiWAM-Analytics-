...
# Uncomment block for data
print "SAFE LAT-LONGS"
...
print "UNSAFE INFOWINDOW_STRING"

for item in unsafe_info_window_string:
	print item


print "Total Safe Sources mapped: "+str(len(safe_markers))
print "Total Unsafe Sources mapped: "+str(len(unsafe_markers))

with open('safe_markers.txt','wb') as fp:
	#for item in safe_markers:
	#	fp.write("%s\n" % item)
	json.dump(safe_markers,fp)

#json_safemarkers = json.dumps(safe_markers)
#print json_safemarkers
